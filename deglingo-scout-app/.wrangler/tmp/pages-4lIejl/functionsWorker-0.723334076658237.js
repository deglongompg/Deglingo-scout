...
// api/sorare/cards.js
var GQL = "https://api.sorare.com/graphql";
var Q = `{ currentUser { slug nickname cards(first: 50, sport: FOOTBALL) { nodes { slug name rarityTyped pictureUrl power cardEditionName ... on Card { player { slug displayName position } } } pageInfo { hasNextPage endCursor } } } }`;
var QP = `query($a:String!){ currentUser { cards(first:50, sport:FOOTBALL, after:$a) { nodes { slug name rarityTyped pictureUrl power cardEditionName ... on Card { player { slug displayName position } } } pageInfo { hasNextPage endCursor } } } }`;
...
// auth/sorare/callback.js
var APP_URL = "https://scout.deglingosorare.com";
var CALLBACK_URL = `${APP_URL}/auth/sorare/callback`;
var TOKEN_URL = "https://api.sorare.com/oauth/token";
...
// ../.wrangler/tmp/pages-4lIejl/functionsRoutes-0.08677030494578408.mjs
var routes = [
  {
